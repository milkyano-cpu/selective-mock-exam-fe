...
export const Sidebar = ({ onClose }: SidebarProps) => {
  ...
  return (
    <div className={[
      ...
      <div className="relative flex flex-col items-start px-6 pb-4 pt-6">
        {isStudent && (
        ...
        <Link 
          href="/dashboard" 
          className="relative -ml-4 flex h-14 items-center overflow-hidden transition-transform hover:scale-105 active:scale-95"
        >
          <img 
