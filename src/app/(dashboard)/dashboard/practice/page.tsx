...
export default function PracticeHubPage() {
  ...
  if (isLoadingSubjects) {
    return (
      <div className="mx-auto max-w-7xl space-y-4 md:space-y-6 animate-pulse">
        <div className="overflow-hidden rounded-3xl border border-slate-200/60 bg-white dark:border-slate-800 dark:bg-slate-900">
          <div className="grid lg:grid-cols-[minmax(0,1.35fr)_minmax(320px,0.65fr)]">
            <div className="bg-[#0b1526] px-5 py-5 sm:min-h-[250px] md:p-8">
              <div className="h-6 w-32 rounded-full bg-white/10" />
              <div className="mt-4 h-8 w-3/4 rounded-lg bg-white/10" />
              <div className="mt-2 h-8 w-1/2 rounded-lg bg-white/10" />
            ...
            <div className="p-5 md:p-8 space-y-3">
              ...
              <div className="flex gap-3">
                {Array.from({ length: 3 }).map((_, i) => (
                  <div key={i} className="h-16 flex-1 rounded-xl bg-slate-100 dark:bg-slate-800/50" />
                ))}
              </div>
            </div>
          </div>
        ...
        <div className="overflow-hidden rounded-3xl border border-slate-200/60 bg-white dark:border-slate-800 dark:bg-slate-900">
          <div className="flex gap-2 overflow-hidden border-b border-slate-100 px-4 py-3 dark:border-slate-800">
            {Array.from({ length: 4 }).map((_, i) => (
              <div key={i} className="h-8 w-20 rounded-full bg-slate-100 dark:bg-slate-800" />
            ))}
          </div>
          <div className="grid gap-3 p-4 md:grid-cols-2 xl:grid-cols-3">
            {Array.from({ length: 6 }).map((_, i) => (
              <div key={i} className="flex min-h-40 flex-col justify-between rounded-2xl border border-slate-200/60 bg-white p-4 dark:border-slate-800 dark:bg-slate-950">
                <div className="space-y-2">
                  <div className="h-4 w-3/4 rounded bg-slate-200/70 dark:bg-slate-700" />
                  <div className="h-3 w-1/2 rounded bg-slate-100 dark:bg-slate-800" />
                </div>
                <div className="mt-4 h-9 rounded-xl bg-slate-100 dark:bg-slate-800" />
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-sm dark:border-slate-800 dark:bg-slate-900">
          ...
          <div className="grid gap-2 p-3 sm:gap-3 sm:p-4 md:grid-cols-2 xl:grid-cols-3">
            {isLoadingTopics ? (
              <>
                {Array.from({ length: 6 }).map((_, i) => (
                  <div key={i} className="flex min-h-40 animate-pulse flex-col justify-between rounded-2xl border border-slate-200/60 bg-white p-3.5 dark:border-slate-800 dark:bg-slate-950 sm:min-h-48 sm:p-4">
                    <div className="space-y-2">
                      <div className="h-4 w-3/4 rounded bg-slate-200/70 dark:bg-slate-700" />
                      <div className="h-3 w-1/2 rounded bg-slate-100 dark:bg-slate-800" />
                    </div>
